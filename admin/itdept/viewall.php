<?php
    ...
    $computer_query = "SELECT * FROM itcomputers";
    $computer_result = $conn->query($computer_query);

    $laptop_query = "SELECT * FROM itlaptops";
    $laptop_result = $conn->query($laptop_query);

    $printer_query = "SELECT * FROM itprinters";
...
<body>
    ...
    <h2 class="text-center text-success">All IT ITEM'S</h2>
                ...
                <tbody>
                    <?php while ($computer_row = $computer_result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td><?php echo $computer_row['device_name']; ?></td>
                            ...
                            <td><?php echo $computer_row['system_type']; ?></td>
                            <td><?php echo $computer_row['pen_touch']; ?></td>
