...
<body>
    <div class="container mt-5">
        <h2 class="text-center mb-5">All AET Items</h2>
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-3" style="width:300px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">View aet computers.</p>
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="width:300px;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">View aet laptops.</p>
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="width:300px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">View aet printers.</p>
