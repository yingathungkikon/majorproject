...
<body>
    <div class="container mt-5">
        <h2 class="text-center mb-4">All BIOTECH Items</h2>
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-3" style="width:300px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">View biotech computers.</p>
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="width:300px;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">View biotech laptops.</p>
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="width:300px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">View biotech printers.</p>
