...
<body>
    ...
    <div class="container mt-5">
        <h3 class="mt-4 mb-3 text-center">Biotech Printers</h3>
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                    ...
                                    echo "<td><button onclick='updatePrinter(" . $row["id"] . ", \"" . $row["brand"] . "\", \"" . $row["model"] . "\", \"" . $row["pr_number"] . "\", \"" . $row["color"] . "\", \"" . $row["type"] . "\", \"" . $row["resolution"] . "\", \"" . $row["problem"] . "\")' class='btn btn-primary'>Update</button>&nbsp;&nbsp;<a href='../includes/delete_printer.php?id=" . $row["id"] . "' class='btn btn-danger'>Delete</a>&nbsp;&nbsp;&nbsp;<button onclick='printQR(\"" . $row["qr_img"] . "\")' class='btn btn-success'>Print</button></td>";
                                echo "</tr>";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm" method="post">
                            ...
                            <div class="mb-3">
                                <label for="pr_number">PR Number:</label> 
                                <input type="text" class="form-control"id="updatePrNumber" name="pr_number"> 
                            </div>
                            <div class="mb-3">
                                <label for="color">Color:</label>
                            ...
                            <div class="mb-3">
                                <label for="resolution">Resolution:</label>
                                <input type="text" class="form-control" id="updateResolution" name="resolution">
                            </div>
                            <div class="mb-3">
                                <label for="problem">Problem:</label>
    ...
    <script>
        function updatePrinter(id, brand, model, pr_number, color,type, resolution, problem) {
                $('#updateId').val(id);
                $('#updateBrand').val(brand);
                $('#updateModel').val(model);
                $('#updatePrNumber').val(pr_number);
                $('#updateColor').val(color);
                $('#updateType').val(type);
                $('#updateResolution').val(resolution);
