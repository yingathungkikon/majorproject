...
<body>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add New Laptop</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="../includes/add_laptop.php" method="post">
                                <div class="mb-3">
    ...
    <div class="container mt-5">
        <h3 class="mt-4 mb-3 text-center">ECE Laptops Inventory</h3>
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                    ...
                                    echo "<td><button onclick='updateLaptop(" . $row["id"] . ", \"" . $row["brand"] . "\", \"" . $row["model"] . "\", \"" . $row["pc_number"] . "\", \"" . $row["processor"] . "\", \"" . $row["ram"] . "\", \"" . $row["storage"] . "\", \"" . $row["problem"] . "\")' class='btn btn-primary'>Update</button>&nbsp;&nbsp;<a href='../includes/delete_laptop.php?id=" . $row["id"] . "' class='btn btn-danger'>Delete</a>&nbsp;&nbsp;&nbsp;<button onclick='printQR(\"" . $row["qr_img"] . "\")' class='btn btn-success'>Print</button></td>";
                                echo "</tr>";
    ...
    <div class="container">
        ...
        <script>
        function updateLaptop(id, brand, model, pc_number, processor, ram, storage, problem) {
            $('#updateId').val(id);
        ...
        $('#updateForm').submit(function(e) {
            ...
            $.ajax({
                url: '../includes/update_laptop.php',
                type: 'POST',
                data: formData,
