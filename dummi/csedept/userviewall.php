<?php
    ...
    $computer_query = "SELECT * FROM csecomputers";
    $computer_result = $conn->query($computer_query);

    $laptop_query = "SELECT * FROM cselaptops";
    $laptop_result = $conn->query($laptop_query);

    $printer_query = "SELECT * FROM cseprinters";
...
<body>
    ...
    <h2 class="text-center text-success">All CSE ITEM'S</h2>
