<?php
    ...
    $computer_query = "SELECT * FROM aetcomputers";
    $computer_result = $conn->query($computer_query);

    $laptop_query = "SELECT * FROM aetlaptops";
    $laptop_result = $conn->query($laptop_query);

    $printer_query = "SELECT * FROM aetprinters";
...
<body>
    ...
    <h2 class="text-center text-success">All AET ITEM'S</h2>
